...
},
{
  ...
  a: [{ text: "Gabrielle Union", isRight: false},
      ...
      {text: "Samantha James", isRight: false}
]
...

{
  ...
  a: [{ text: "Miami Heat", isRight: false},
      ...
      { text: "Cleveland Cavaliers", isRight: true},
]
},
...

{
  ...
  a: [{ text: "Miami beach", isRight: false},
      ...
      { text: "Los Angeles", isRight: false},
]
},
...

{
  ...
  a: [{ text: "ALL-star Honors", isRight: false},
      ...
      { Text: "Western Honors", isRight: false},
]
},
...

{
  ...
  a: [{ text: "Didn't go to college", isRight: true},
      ...
      { text: "Arizona State", isRight: false},
]
},
...

{
  ...
  a: [{ text: "Miami Heat", isRight: true},
      ...
      { text: "Cleveland Cavaliers", isRight: false},
]
},
...

{
  ...
  a: [{ text: "Golden State Warriors", isRight: true},
      ...
      { text: "Toronto Raptors", isRight: false},
]
},
...

{
  ...
  a: [{ text: "San Antonio Spurs", isRight: false},
      ...
      { text: "Oklahoma City Thunder", isRight: true},
]
},
...

{
  ...
  a: [{ text: "Ty Lue", isRight: false},
      ...
      { text: "Erik Spoelstra", isRight: true},
]
},
...

{
  ...
  a: [{ text: "Hamilton High School", isRight: false},
      ...
      { text: "St. Vincent-St. Mary", isRight: true},
]
},
...
// True or false value for the options
op1.value = Questions[id].a[0].isRight;
op2.value = Questions[id].a[1].isRight;
op3.value = Questions[id].a[2].isRight;
op4.value = Questions[id].a[3].isRight;
...
const nextquestion = document.getElementsByClassName('nextquestion')[0];
var id = 0;
